...
export class Contract__membersResult {
  value0: Address;
  value1: BigInt;
  value2: boolean;
  value3: BigInt;
...
export class Contract__proposalQueueResult {
  value0: Address;
  value1: Address;
  value2: BigInt;
  value3: BigInt;
...
export class Contract extends SmartContract {
  ...
  members(param0: Address): Contract__membersResult {
    let result = super.call("members", [EthereumValue.fromAddress(param0)]);
    return new Contract__membersResult(
      result[0].toAddress(),
      result[1].toBigInt(),
      result[2].toBoolean(),
      result[3].toBigInt()
  ...
  proposalQueue(param0: BigInt): Contract__proposalQueueResult {
    let result = super.call("proposalQueue", [
      EthereumValue.fromUnsignedBigInt(param0)
    ]);
    return new Contract__proposalQueueResult(
      result[0].toAddress(),
      result[1].toAddress(),
      result[2].toBigInt(),
      result[3].toBigInt(),
